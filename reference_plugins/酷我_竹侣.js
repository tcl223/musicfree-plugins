...
async function $4e63e094b4590b2b$var$getMediaSource(musicItem, quality) {
    ...
    const apiQuality = qualityMap[quality] || "320k";
    const songId = musicItem.id;
    
    const response = await (0, ($parcel$interopDefault($M8GQN$axios))).get(`http://kwdec.942240.xyz/kwurl`, {
        params: {
            id: songId,
            q: apiQuality
        },
...
const $4e63e094b4590b2b$var$pluginInstance = {
    ...
    author: "竹佀",
    version: "1",
    srcUrl: "https://raw.gitcode.com/Crystim/mfp/raw/main/%E9%85%B7%E6%88%91_%E7%AB%B9%E4%BE%A3.js",
