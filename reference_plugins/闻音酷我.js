...
async function $4e63e094b4590b2b$var$getLyric(musicItem) {
    const res = await (0, ($parcel$interopDefault($M8GQN$axios))).get(`https://kw-api.cenguigui.cn`, {
        params: {
            id: musicItem.id,
            type: "lyr",
            format: "all"
    ...
    if (res.data && res.data.code === 200 && res.data.data && res.data.data.lrclist) {
        return {
            rawLrc: res.data.data.lrclist
        };
    }
...
const $4e63e094b4590b2b$var$pluginInstance = {
    ...
    author: "竹佀",
    version: "2",
    srcUrl: "https://raw.gitcode.com/Crystim/mfp/raw/main/%E9%97%BB%E9%9F%B3%E9%85%B7%E6%88%91.js",
