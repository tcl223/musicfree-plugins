...
async function getMediaSource(musicItem, quality) {
  ...
  const targetQuality = qualityLevels[quality] || '128k';
  const apiQuality = qualityMap[targetQuality] || 'standard';
  const res = (
    await axios_1.default.get(
      `https://www.cunyuapi.top/163music_play?id=${musicItem.id}&quality=${apiQuality}`
    )
  ).data;
  return {
    url: res.song_file_url
  };
}
const headers = {
  authority: "music.163.com",
...
module.exports = {
  platform: "网易(bimiao音源)",
  author: "玥然OvO",
  version: "1.1",
  appVersion: ">0.1.0-alpha.0",
  srcUrl: "https://raw.gitcode.com/Crystim/mfp/raw/main/%E7%BD%91%E6%98%93bimiao.js",
