...
async function $69c13ef3ab1c1f3e$var$getMediaSource(musicItem, quality) {
    ...
    const apiUrl = `https://api.cenguigui.cn/api/netease/music_v1.php?id=${musicItem.id}&type=json&level=${apiQuality}`;
    
    try {
        const response = await (0, ($parcel$interopDefault($8Nr7K$axios))).get(apiUrl, {
            headers: {
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.135 Safari/537.36',
                'Referer': 'https://music.163.com'
            },
        ...
        if (!response.data || !response.data.data || !response.data.data.url) {
            throw new Error('API响应中没有有效的URL');
        }
...
const $69c13ef3ab1c1f3e$var$pluginInstance = {
    ...
    author: "竹佀",
    version: "1",
    srcUrl: "https://raw.gitcode.com/Crystim/mfp/raw/main/%E7%BD%91%E6%98%93_%E7%AC%AD%E9%AC%BC%E9%AC%BC.js",
